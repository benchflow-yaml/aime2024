#!/usr/bin/env python3
# BenchFlow Interface for AIME 2024
# This file is a template for integrating AIME 2024 with BenchFlow
...
class BenchflowInterface:
    ...
    def load_benchmark(self) -> bool:
        ...
        try:
            ...
            print(f"Loading AIME 2024 benchmark...")
            return True
    ...
    def get_benchmark_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "github": "https://github.com/aime-math/aime-2024",
            "paper": "",
            "website": ""
        }
